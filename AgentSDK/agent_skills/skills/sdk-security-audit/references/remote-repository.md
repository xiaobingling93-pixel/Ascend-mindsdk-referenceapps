...
本文档描述如何处理 GitCode/GitHub/GitLab 等远程仓库的安全审计请求。
...
|---------|---------|------|---------|
| `https://gitcode.com/Ascend/VisionSDK` | `https://gitcode.com/Ascend/VisionSDK.git` | 默认 | `/` |
| `https://gitcode.com/Ascend/VisionSDK/tree/master` | `https://gitcode.com/Ascend/VisionSDK.git` | `master` | `/` |
| `https://gitcode.com/Ascend/VisionSDK/tree/master/mxBase` | `https://gitcode.com/Ascend/VisionSDK.git` | `master` | `/mxBase` |
| `https://gitcode.com/Ascend/VisionSDK/tree/dev/src/core/utils.cpp` | `https://gitcode.com/Ascend/VisionSDK.git` | `dev` | `/src/core/utils.cpp` |
...
```bash
# 默认分支（浅克隆）
git clone --depth 1 https://gitcode.com/owner/repo.git sdk-audit-repo-20260316

# 指定分支（浅克隆）
git clone --depth 1 -b branch_name https://gitcode.com/owner/repo.git sdk-audit-repo-20260316
```

**目录命名规则**：`sdk-audit-{repo_name}-{date}`
